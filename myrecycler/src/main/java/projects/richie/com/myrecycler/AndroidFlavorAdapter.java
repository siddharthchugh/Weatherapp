...
*//*
    ...
    static public class MovieHolder{
        ...
        MovieHolder(View v){
            versionNameView = (TextView) v.findViewById(R.id.categoryTitle);
    }
...
*//*
        ...
        mHolder.versionNameView = (TextView) convertView.findViewById(R.id.categoryTitle);
        mHolder.versionNameView.setText(in.getMovieName());
...
public class AndroidFlavorAdapter extends RecyclerView.Adapter<AndroidFlavorAdapter.MyHolder>{
    ...
    Context context;
    public AndroidFlavorAdapter(Context con,List<HospitalDetail> hs){
        this.context= con;
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        View vw = inflater.inflate(R.layout.list_items_detail,parent,false);
    ...
    public void onBindViewHolder(MyHolder myHolder, int position) {
        ...
        HospitalDetail current = ls.get(position);
        myHolder.tv.setText(current.getTitle());
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyHolder(View itemView) {
         ...
         //   iv = (ImageView) itemView.findViewById(R.id.listicon);
            tv = (TextView) itemView.findViewById(R.id.hospitalName);
        }
